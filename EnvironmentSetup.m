...
%     properties
%         objectVertices = {};  % Cell array to store vertices of each object
%     end
% 
%     methods
...
% 
%             % Store the transformed vertices for collision detection
%             self.objectVertices{end+1} = verts(:, 1:3);
%             hold on;
%         end
% 
%         function allVertices = GetEnvironmentVertices(self)
%             % Collect all vertices from objects for collision detection
%             allVertices = vertcat(self.objectVertices{:});
%         end
%     end
% end
